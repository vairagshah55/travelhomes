                ...
                >
                  ...
                  <div className="flex gap-2 mt-3 md:mt-0">
                    <button
                      ...
                      className="px-5 py-2 bg-white dark:bg-black dark:text-white text-black text-sm rounded-full border border-gray-400 hover:bg-gray-800 hover:text-white transition flex items-center"
                    >
                      View More <SlArrowDown className="ml-2 h-3 w-3" />
                    </button>
                    <button
                      onClick={() => handleOpenApply(job)}
                      className="px-5 py-2 bg-black dark:bg-white dark:text-black text-white text-sm rounded-full border border-gray-400 hover:bg-gray-800 hover:text-white transition flex items-center"
                    >
                      Apply
                    </button>
                  </div>
