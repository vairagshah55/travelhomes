...
const EditProfileSidebar = ({ user, photoPreview, onPhotoFileChange, onBack }: any) => (
  <div className="bg-black rounded-md p-8 text-white max-md:hidden lg:w-80 flex-shrink-0">
...
const EditProfileForm = ({ formData, handleInputChange, onSave }: EditProfileFormProps) => (
      ...
      <div className="px-4 mt-20 md:px-20 py-10 max-md:py-0">
        <div className="flex flex-col lg:flex-row gap-12 max-w-7xl mx-auto">
          ...
          <EditProfileSidebar
            ...
            onPhotoFileChange={(e: any) => setPhotoFile(e.target.files?.[0] || null)}
            onBack={() => navigate(-1)}
          />
