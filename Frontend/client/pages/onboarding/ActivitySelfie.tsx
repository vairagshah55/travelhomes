...
const ActivitySelfie = () => {
  ...
  return (
    <div className="onboarding-layout h-screen flex flex-col bg-white overflow-hidden">
      {/* Header */}
      <div className="flex h-14 w-full items-center justify-start px-6 lg:px-16 border-b border-ds-pebble shrink-0">
        <LogoWebsite />
      </div>
      ...
      <div className="flex-1 flex flex-col items-center px-6 py-8 overflow-hidden pb-28">
        <div className="flex flex-col items-center gap-6 w-full max-w-2xl">
          ...
          {/* Camera / Preview */}
          <div className="relative w-full h-80 bg-ds-linen rounded-2xl overflow-hidden">
            {capturedImage ? (
              <img
                src={capturedImage}
                alt="Captured selfie"
              ...
              <>
                ...
                />
                {!isStreaming && (
                  <div className="absolute inset-0 flex items-center justify-center bg-ds-pebble">
          ...
          {!capturedImage && isStreaming && (
            <button
              ...
              className="w-16 h-16 border-4 border-white rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
