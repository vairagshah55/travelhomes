        ...
        <div className="flex-1 flex flex-col pr-5 pb-5 overflow-hidden">
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-dashboard-stroke dark:border-gray-700 bg-white dark:bg-gray-800 rounded-t-3xl flex-shrink-0">
            <div className="flex items-center gap-3 min-w-0">
              ...
              {o?.status && (
                <span
                  className={`text-xs font-semibold px-2.5 py-1 rounded-full capitalize flex-shrink-0 ${STATUS_STYLES[o.status] || "bg-gray-100 text-gray-500"}`}
                >
                  {o.status}
                </span>
              )}
            ...
            <div className="p-5">
              ...
              {o && (
                <div className="max-w-5xl mx-auto space-y-4">
                  ...
                  <Section
                    title="Description"
                    expanded={expanded.descriptions}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {o.features.filter(Boolean).map((f, i) => (
                            <span
                              key={i}
                              className="text-xs font-medium px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-700 text-dashboard-title dark:text-gray-300 font-plus-jakarta"
                            >
                              {f}
                            </span>
                          ))}
                          ...
                          {filled(o.photos?.coverUrl) && (
                            <div className="lg:col-span-1">
                              <div
                                ...
                                style={{
                                  backgroundImage: `url(${getImageUrl(o.photos.coverUrl!)})`,
                                }}
                              >
                    ...
                    >
                      ...
                      {(filled(o.seatingCapacity) ||
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
                          {filled(o.seatingCapacity) && (
                            <Row label="Seating Capacity" value={o.seatingCapacity} />
                          )}
                          {filled(o.sleepingCapacity) && (
                            <Row label="Sleeping Capacity" value={o.sleepingCapacity} />
                          )}
                          {filled(o.guestCapacity) && (
                            <Row label="Guest Capacity" value={o.guestCapacity} />
                          )}
                          ...
                          {filled(o.personCapacity) && (
                            <Row label="Person Capacity" value={o.personCapacity} />
                          )}
                        </div>
                      )}
