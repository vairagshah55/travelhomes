      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-semibold opacity-75">Share on Social Media</h3>
          ...
          <div className="space-y-3 border-t border-gray-300 dark:border-gray-600 pt-4">
            <h3 className="text-sm font-semibold opacity-75">Share Link</h3>
            <div
            ...
            {copied && <p className="text-xs text-green-500">URL copied to clipboard!</p>}
          </div>

          {/* Download PDF Section */}
          <div className="space-y-3 border-t border-gray-300 dark:border-gray-600 pt-4">
            <h3 className="text-sm font-semibold opacity-75">Download Details</h3>
            <Button
