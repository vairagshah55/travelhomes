...
const Settings = () => {
  ...
  const activeSection: "general" | "account" | "preferences" = location.pathname.endsWith(
    "/account",
  )
    ? "account"
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md leading-relaxed font-plus-jakarta">
                Our team will review your information and get in touch with you shortly. Stay tuned
