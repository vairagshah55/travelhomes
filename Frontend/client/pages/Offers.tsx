        ...
        <div className="flex-1 flex flex-col pt-[80px] pr-5 pb-5 overflow-y-auto scrollbar-hide">
            ...
            <div className="flex gap-2">
              {(["pending", "approved", "cancelled"] as const).map((t) => (
                <Button
                  ...
                  onClick={() => setTab(t)}
                  className={tab === t ? "bg-dashboard-primary text-white" : ""}
                >
              ...
              <div className="border border-dashboard-stroke rounded-xl overflow-auto">
                ...
                {loading ? (
                  ...
                  items.map((o, idx) => (
                    <div
                      key={o._id || idx}
                      className={`grid grid-cols-12 gap-3 px-4 py-3 items-center ${idx !== items.length - 1 ? "border-b border-gray-100" : ""}`}
                    >
                      <div className="col-span-4 flex items-center gap-3">
                        {o.photos?.coverUrl ? (
                          <img
                            src={
                              /^https?:\/\//i.test(o.photos.coverUrl) ||
                              o.photos.coverUrl.startsWith("data:")
                                ? o.photos.coverUrl
              ...
              <div className="bg-white rounded-xl p-6 w-full max-w-2xl mx-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      value={(editForm.locality as any) || ""}
                ...
                <div className="mt-6 flex justify-end gap-3">
                  ...
                  <Button onClick={onSaveEdit} className="bg-dashboard-primary text-white">
                    Save
                  </Button>
                </div>
              </div>
          ...
          <div className="flex justify-end items-center gap-4 px-5 py-4 bg-white dark:bg-gray-800 dark:border-gray-600">
            <Button
              ...
              className="text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20 font-geist"
            >
              Back
            </Button>
          </div>
