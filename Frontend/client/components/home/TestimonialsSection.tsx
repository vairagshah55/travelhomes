          ...
          rightContent={
            <div className="flex items-center gap-3">
              ...
              <Button
                size="icon"
                onClick={scrollRight}
                className="h-10 w-10 rounded-full bg-blue-600 hover:bg-blue-700 text-white transition-all duration-200 shadow-sm hover:shadow-md active:scale-95"
              >
        ...
        >
          ...
          <div className="flex justify-center mt-10">
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-8 h-11 transition-all duration-200 font-medium flex items-center gap-2 shadow-sm hover:shadow-md active:scale-[0.98]"
            >
      ...
      <Dialog open={showReviewModal} onOpenChange={setShowReviewModal}>
        <DialogContent className="bg-white text-black dark:bg-gray-900 dark:text-white rounded-2xl sm:rounded-2xl max-w-md">
          ...
          <form onSubmit={handleSubmitReview} className="space-y-5">
            {/* User info */}
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full overflow-hidden ring-2 ring-blue-100 flex-shrink-0">
                  ...
                  <motion.button
                    ...
                    className={`w-8 h-8 rounded-full border text-sm font-semibold transition-colors duration-150 flex items-center justify-center ${
                      reviewRating >= n
                        ...
                        : "bg-white dark:bg-gray-800 text-gray-500 border-gray-200 hover:border-blue-400"
                    }`}
                  >
                    {n}
                  </motion.button>
            ...
            <Textarea
              ...
              required
              className="min-h-[120px] resize-none border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 rounded-xl text-sm"
            />
            ...
            <div className="flex justify-end gap-2 pt-1">
              ...
              <Button
                type="submit"
                className="rounded-full bg-blue-600 hover:bg-blue-700 text-white px-5 h-10 text-sm shadow-sm hover:shadow-md transition-all active:scale-[0.98]"
              >
                Submit
              </Button>
            </div>
