      ...
      {(actionLabel || secondaryLabel) && (
        <div className="flex items-center gap-2">
          {actionLabel && onAction && (
            <button
              onClick={onAction}
              className="bg-[#185FA5] hover:bg-[#0C447C] text-white rounded-full px-5 h-9 text-[13px] font-semibold transition-colors duration-150 shadow-sm hover:shadow-md"
            >
              {actionLabel}
            </button>
          )}
          {secondaryLabel && onSecondary && (
            <button
              onClick={onSecondary}
              className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-full px-5 h-9 text-[13px] font-semibold transition-colors duration-150"
            >
              {secondaryLabel}
            </button>
          )}
