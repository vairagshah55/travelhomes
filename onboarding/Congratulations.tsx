      ...
      <div className="onboarding-footer">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
          ...
          <div className="flex items-center gap-4 sm:gap-6 order-1 sm:order-2">
            {/* <button
              onClick={handleEdit}
              className="flex items-center justify-center px-6 sm:px-8 py-[14px] h-[50px] border bg-white dark:bg-gray-800 dark:text-gray-300 rounded-[60px] hover:bg-gray-50 dark:hover:bg-gray-700 hover:shadow-md transition-all duration-200 focus-ring"
              style={{
                borderColor: 'var(--congratulations-secondary-400)',
                color: 'var(--congratulations-secondary-500)'
              }}
