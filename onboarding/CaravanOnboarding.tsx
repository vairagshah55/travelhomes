        ...
        try {
          ...
          if (data && data.type === 'caravan' && data.doc && ['pending', 'draft', 'rejected'].includes(data.doc.status)) {
            ...
            setFormData(prev => ({
              ...
              dateOfBirth: doc.dateOfBirth || (userDetails?.dateOfBirth ? new Date(userDetails.dateOfBirth).toISOString().split('T')[0] : ""),
...
const mapSrcbusiness = `https://www.google.com/maps?q=${encodeURIComponent(
  ...
  return (
    <>
      ...
      {/* Header */}
      <div className="flex w-full z-30 fixed items-center justify-start px-20 py-5">
        <LogoWebsite />
      </div>
...
/>
  ...
  inputMode="numeric"
  placeholder="Pincode"
  className="flex-1 h-[50px] px-3  border border-[#EAECF0] dark:border-gray-600 rounded-lg text-sm text-[#121213] dark:text-gray-300 font-['Plus_Jakarta_Sans'] bg-white dark:bg-gray-800 focus:outline-none focus:border-[#131313]"
/>
          ...
          {currentStep === 7 && (
            <div className="w-full flex flex-col items-center gap-9">
              ...
              <div className="w-full  max-w-4xl mx-auto flex flex-col gap-5">
                ...
                {/* State & City */}
                <div className="w-full flex justify-between items-center gap-5 max-md:flex-wrap">
                  <div className="flex-1 flex flex-col gap-3">
                    <label className="text-base text-[#334054] dark:text-gray-300 font-['Plus_Jakarta_Sans'] pl-1">
                      Country
                    </label>
                    <div className="relative">
                      <select
                        ...
                        className={`w-full h-[50px] px-3 py-4 border ${errors.personalLocality ? "border-red-500" : "border-[#EAECF0] dark:border-gray-600"} rounded-lg text-sm text-[#121213] dark:text-gray-300 font-['Plus_Jakarta_Sans'] bg-white dark:bg-gray-800 focus:outline-none focus:border-[#131313] appearance-none`}
                      >
                        <option value="India" >
                         India
                        </option>
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`w-full h-[50px] px-3 py-4 border ${errors.personalState ? "border-red-500" : "border-[#EAECF0] dark:border-gray-600"} rounded-lg text-sm text-[#121213] dark:text-gray-300 font-['Plus_Jakarta_Sans'] bg-white dark:bg-gray-800 focus:outline-none focus:border-[#131313] appearance-none`}
                      >
                        <option value="" disabled>
                          Select State
                        </option>
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`w-full h-[50px] px-3 py-4 border ${errors.personalCity ? "border-red-500" : "border-[#EAECF0] dark:border-gray-600"} rounded-lg text-sm text-[#121213] dark:text-gray-300 font-['Plus_Jakarta_Sans'] bg-white dark:bg-gray-800 focus:outline-none focus:border-[#131313] appearance-none`}
                      >
                        <option value="" disabled>
                          Select City
                        </option>
                ...
                <div className="flex gap-5">
                  <div className="flex-1 flex flex-col gap-3">
                    ...
                    <input
                      ...
                      className={`w-full h-[50px] px-3 py-4 border ${errors.dateOfBirth ? "border-red-500" : "border-[#EAECF0] dark:border-gray-600"} rounded-lg text-sm text-[#121213] dark:text-gray-300 font-['Plus_Jakarta_Sans'] bg-white dark:bg-gray-800 focus:outline-none focus:border-[#131313]`}
                    />
                    {errors.dateOfBirth && (
                      <span className="text-xs text-red-500 pl-1">
                        {errors.dateOfBirth}
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`w-full h-[50px] px-3 py-4 border ${errors.maritalStatus ? "border-red-500" : "border-[#EAECF0] dark:border-gray-600"} rounded-lg text-sm text-[#121213] dark:text-gray-300 font-['Plus_Jakarta_Sans'] bg-white dark:bg-gray-800 focus:outline-none focus:border-[#131313] appearance-none`}
                      >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full h-[50px] px-3 py-4 border ${errors.idProof ? "border-red-500" : "border-[#EAECF0] dark:border-gray-600"} rounded-lg text-sm text-[#121213] dark:text-gray-300 font-['Plus_Jakarta_Sans'] bg-white dark:bg-gray-800 focus:outline-none focus:border-[#131313] appearance-none`}
                    >
                      <option value="">Select</option>
  ...
  <div className="max-w-4xl mx-auto w-full flex justify-between items-center gap-5">
    ...
    {currentStep === 8 ? (
      ...
      <button
        ...
        onClick={handleNext}
        disabled={isLoading}
        className="mx-auto flex items-center justify-center px-8 py-[14px] bg-[#131313] hover:bg-gray-800 text-white rounded-[60px] w-[250px]"
      >
