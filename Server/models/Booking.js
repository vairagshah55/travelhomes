...
//  - "list my bookings" → by userId, newest first
//  - "list bookings for a listing" → by serviceId
...
// bookingId already gets a unique index via the field-level `unique: true` above.
