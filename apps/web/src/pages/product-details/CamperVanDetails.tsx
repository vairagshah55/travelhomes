...
export default function UniqueStayDetails() {
  ...
  const getAmenityIcon = (name: string) => {
    ...
    if (
      ...
      lowerName.includes("utensils") ||
      lowerName.includes("cook")
    )
      return FaUtensils;
    if (lowerName.includes("fridge") || lowerName.includes("refrigerator")) return RiFridgeLine;
    if (
      lowerName.includes("ac") ||
      lowerName.includes("air condition") ||
      lowerName.includes("heater") ||
      lowerName.includes("temperature")
    )
      return Thermometer;
    if (lowerName.includes("music") || lowerName.includes("speaker") || lowerName.includes("audio"))
      return FaMusic;
    if (
    ...
    if (
      ...
      lowerName.includes("outdoor cook")
    )
      return MdOutlineOutdoorGrill;
    if (lowerName.includes("tent") || lowerName.includes("camp")) return GiCampingTent;
    if (lowerName.includes("car") || lowerName.includes("parking") || lowerName.includes("garage"))
      return FaCarSide;
            ...
            <div ref={contentRef} className="max-w-[1440px] mx-auto px-4 sm:px-6 py-5 z-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 mt-1">
                ...
                <div className="lg:col-span-2 mt-3">
                  <StickyNavBar tabs={tabs} activeTab={activeTab} setActiveTab={setActiveTab} layoutIdPrefix="campervan-tab" />
