    ...
    <div className="min-h-screen flex-col flex gap-0 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-200 transition-colors">
      ...
      <section className="max-w-7xl  mx-auto px-4 md:px-10 py-16 grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-4 animate-fadeIn">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300">
            At Travel Homes, we believe travel is more than just reaching a destination—it’s about
            creating unforgettable experiences, building connections, and feeling at home wherever
            you go.
          </p>
          <div className="flex gap-5 items-center">
            <Link to="/">
              <button className="inline-block px-8 my-3 py-4 bg-[#3BD9DA] text-white dark:bg-white dark:text-black rounded-md shadow-lg hover:scale-105 transition-transform duration-300">
                Book Now
              </button>
            </Link>
            <Button
      ...
      <section className="max-w-7xl flex flex-col md:flex-row justify-between w-full mx-auto px-4 py-8 gap-8 animate-fadeIn delay-200">
        ...
        <div className="flex w-full md:w-1/2 flex-wrap gap-8 sm:gap-12 md:gap-20 mt-8 text-center font-semibold">
          ...
          <div>
            ...
            <p className="text-sm text-[#979797]">Homes participate eco-friendly</p>
          </div>
          <div>
            <span className="text-3xl md:text-4xl">1M+</span>
            <p className="text-sm text-[#979797]">Satisfied travelers since 2015.</p>
          </div>
          <div>
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            <div className="bg-white text-center p-6 rounded-lg shadow w-full md:w-1/3 dark:bg-black border dark:border-slate-100">
              ...
              <p className="text-gray-600 dark:text-white">
                We believe in creating welcoming experiences that go beyond expectations. Whether
                it’s through attentive service, a friendly smile, or thoughtful details, our
                commitment to hospitality ensures every interaction feels personal, warm, and
                memorable. We treat every individual with respect and care—because at the heart of
                everything we do, people come first.
              </p>
            </div>
      ...
      <section className="max-w-7xl mt-20 mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
        <div className="border p-5 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 dark:text-white">
            Viverra ut potenti aliquam feugiat dui imperdiet laoreet tempus sed. Elit cursus est
            lorem in est id nec. Quis diam posuere at nisl eget turpis sagittis nunc. Aliquet et
            ultrices purus, id. Sagittis erat nunc in parturient, ut potenti aliquam feugiat dui
            imperdiet laoreet tempus sed. Elit cursus est lorem in est id nec. Quis diam posuere at
            nisl eget turpis.
          </p>
        </div>
