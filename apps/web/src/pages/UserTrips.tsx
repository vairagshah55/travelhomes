              ...
              <>
                ...
                {trip.bookingStatus !== "cancelled" && (
                  <Button
                    ...
                    size="sm"
                    className="bg-[#1E3A8A] text-white hover:bg-[#2D4DA8] rounded-full text-xs font-geist"
                  >
                    Review
                  </Button>
                )}
        ...
        <div className="p-6">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <Button
              ...
              className="flex-1 bg-black hover:bg-[#1E3A8A] text-white"
            >
              Cancel Reservation
            </Button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex border-b border-gray-200 mb-8 overflow-x-auto no-scrollbar">
            ...
            >
              Upcomings
              {activeTab === "upcoming" && (
                <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#1E3A8A] dark:bg-white"></div>
              )}
            </button>
            <button
