              ...
              <>
                ...
                {trip.bookingStatus !== "cancelled" && (
                  <Button
                    ...
                    size="sm"
                    className="bg-[#0F5C8A] text-white hover:bg-[#14709F] rounded-full text-xs font-geist"
                  >
                    Review
                  </Button>
                )}
        ...
        <div className="p-6">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <Button
              ...
              className="flex-1 bg-black hover:bg-[#0F5C8A] text-white"
            >
              Cancel Reservation
            </Button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex border-b border-gray-200 mb-8 overflow-x-auto no-scrollbar">
            ...
            >
              Upcomings
              {activeTab === "upcoming" && (
                <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#0F5C8A] dark:bg-white"></div>
              )}
            </button>
            <button
