      ...
      >
        <p
          className={`text-sm md:text-base  leading-relaxed flex-1 ${
            openAns ? "text-gray-800 dark:text-white" : "text-gray-900 dark:text-white"
          }`}
        >
          {question}
        </p>
    ...
    <>
      <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-200 transition-colors">
        ...
        <section className="w-full mt-20 relative h-[300px] md:h-[350px] ">
          <img src="/career.jpg" alt="Career Banner" className="w-full h-full object-cover" />
          <div className="gap-6 absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center text-white text-center px-4">
            ...
            <p className="max-w-2xl text-sm md:text-base">
              ...
              community driven by innovation, collaboration, and a shared vision to make a
              difference.
            </p>
        ...
        <section className="max-w-7xl mx-auto w-full">
            ...
            <div className="flex-1 p-6 border rounded-lg flex items-center justify-center">
              <div className="max-w-2xl flex flex-col gap-5">
                ...
                <p className="text-gray-600 dark:text-white text-sm md:text-base text-center lg:text-left">
                  At Travel Homes, we empower individuals to unlock the potential of their homes by
                  hosting travelers from around the globe. Whether you own a cozy apartment, a
                  serene villa, or a unique getaway, becoming a host with us is your gateway to
                  earning extra income while creating unforgettable guest experiences.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col lg:flex-row gap-10 justify-between items-center mt-12 px-4 md:px-14">
            ...
            <div className="flex-1 text-center lg:text-left">
              <p className="text-xl sm:text-2xl font-bold mt-4">Your Home Could Make</p>

              <h2 className="text-3xl sm:text-4xl font-bold text-black dark:text-white mt-2">
                ₹93,000
              </h2>

              <p className="text-lg sm:text-xl font-bold">on Travel Homes</p>
              ...
              <p className="text-xs text-black dark:text-white mt-4 leading-relaxed max-w-lg mx-auto lg:mx-0">
                ...
                Developers to join our fast-paced Engineering team. You will work closely with
                Product, Design and Marketing to analyze, develop and debug.
              </p>

              <p className="text-xs text-black dark:text-white mt-4 leading-relaxed max-w-lg mx-auto lg:mx-0">
                Due to growing workload, we are looking for experienced and talented Full-Stack
                Developers to join our fast-paced Engineering team.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-t from-[#FFFFFF] to-[#d7e1f0] p-6 rounded-xl shadow dark:bg-black border dark:border-slate-300 w-full max-w-md">
              <h3 className="font-bold mb-6 text-xl">Profit Calculator</h3>

              {/* RENTAL */}
              <div className="mb-6">
                <p className="text-sm font-medium text-gray-500 mb-1">Per Day Rental</p>

                <p className="font-bold text-lg text-center mb-2">₹{rental.toLocaleString()}</p>
              ...
              {/* DAYS */}
              <div className="mb-4">
                <p className="text-sm font-medium text-gray-500 mb-1">Occupancy In A Month</p>

                <p className="font-bold text-lg text-center mb-2">{days} Day</p>
          ...
          <div className="w-full grid gap-6 grid-cols-1 md:grid-cols-2 my-12 px-4 md:px-14">
            {cardList.map((card) => (
              <div key={card.title} className="bg-white dark:bg-black shadow rounded-lg p-6">
                ...
                <div className="flex justify-end gap-2 flex-wrap">
                  <button className="px-4 py-2 bg-[#117479] text-white rounded-full">Apply</button>
          ...
          <div className="w-full my-10 px-4 md:px-14">
            <h2 className="text-2xl font-bold text-center mb-4">Benefits of Working With Us</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {hostBenefits.map((benefit) => (
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-white">{benefit.text}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="w-full px-4 md:px-14 py-12">
            <div className="flex flex-col lg:justify-between gap-4 lg:flex-row">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <Button
                  size="icon"
                  className="h-12 w-12 rounded-full dark:bg-white dark:text-black bg-[#117479] text-white"
                  onClick={scrollRight}
                >
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between gap-12 mx-auto">
              ...
              <div className="text-center lg:text-left w-full lg:w-4/12">
                ...
                <p className="text-gray-600 text-center dark:text-gray-300 max-w-2xl mx-auto lg:mx-0 mb-8 text-sm sm:text-base">
                  We’re here to make your experience as smooth as possible. This section provides
                  clear explanations, useful tips, and detailed guidance to help you get the most
                  out of our platform.{" "}
                </p>
