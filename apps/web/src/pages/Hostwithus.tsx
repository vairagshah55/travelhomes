            ...
            {cardList.map((card) => (
              <div key={card.title} className="bg-white dark:bg-black shadow rounded-lg p-6">
                ...
                <div className="flex justify-end gap-2 flex-wrap">
                  <button className="px-4 py-2 bg-[#3BD9DA] text-white rounded-full">Apply</button>
          ...
          <div className="w-full px-4 md:px-14 py-12">
            <div className="flex flex-col lg:justify-between gap-4 lg:flex-row">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <Button
                  size="icon"
                  className="h-12 w-12 rounded-full dark:bg-white dark:text-black bg-[#3BD9DA] text-white"
                  onClick={scrollRight}
                >
