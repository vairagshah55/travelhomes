        ...
        {CARDS.map((c, i) => (
          ...
          >
            ...
            <div className="flex items-start justify-between">
              ...
              <ArrowRight
                size={18}
                className="text-gray-300 transition-all duration-200 group-hover:text-[#0F5C8A] group-hover:translate-x-1"
              />
            </div>
