        ...
        <div className="flex gap-3 items-start">
          ...
          <div className="relative flex-shrink-0" ref={phoneDropdownRef}>
            <button
              ...
              className={`flex items-center gap-1.5 h-11 px-3 rounded-xl border bg-gray-50/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-[#128086] transition-all duration-200 min-w-[88px] ${
                phoneDropdownOpen
                    ...
                    <li
                      ...
                      className={`flex items-center gap-2.5 px-2.5 py-2 rounded-xl cursor-pointer transition-colors ${
                        phoneCountry?.isoCode === c.isoCode
                          ...
                          : "hover:bg-gray-50 dark:hover:bg-[#128086]/50"
                      }`}
                    >
      ...
      >
          ...
          <div className="flex gap-2" ref={dobWrapperRef}>
            ...
            <div className="relative" style={{ width: "76px" }}>
              <button
                ...
                className={`h-11 w-full flex items-center justify-between px-3 border rounded-xl text-sm bg-gray-50/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-[#128086] transition-all duration-200 ${
        ...
        <div className="relative" ref={stateDropdownRef}>
          <button
            ...
            className={`h-11 w-full flex items-center justify-between border rounded-xl px-4 text-sm font-medium bg-gray-50/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-[#128086] transition-all duration-200 ${
              errors.state
                ? "border-red-500"
                : stateOpen
                  ? "border-gray-900 dark:border-white shadow-[0_0_0_3px_rgba(0,0,0,0.06)] dark:shadow-[0_0_0_3px_rgba(255,255,255,0.08)]"
                    ...
                    <li
                      ...
                      className={`px-2.5 py-2 rounded-xl cursor-pointer text-sm transition-colors ${
                        state === s.name
                          ...
                          : "text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-[#128086]/50"
                      }`}
                    >
                      {s.name}
                    </li>
        ...
        <div className="relative" ref={cityDropdownRef}>
          <button
            ...
            disabled={!state}
            className={`h-11 w-full flex items-center justify-between border rounded-xl px-4 text-sm font-medium bg-gray-50/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-[#128086] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${
              errors.city
                ? "border-red-500"
                : cityOpen
                  ? "border-gray-900 dark:border-white shadow-[0_0_0_3px_rgba(0,0,0,0.06)] dark:shadow-[0_0_0_3px_rgba(255,255,255,0.08)]"
