          ...
          {currentStep === 2 && (
            <form onSubmit={handleVerifyOtp} noValidate className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-gray-900 dark:bg-white dark:text-black text-white py-3 rounded-full font-medium text-sm hover:bg-[#128086] dark:hover:bg-gray-100 transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50"
              >
