        ...
        <main className="flex-1 p-4 lg:p-5 dark:bg-black dark:text-white bg-white m-2 lg:m-5 rounded-2xl lg:rounded-3xl overflow-auto">
          ...
          <div className="flex items-center justify-between gap-6 border-b border-dashboard-stroke pb-4 mb-5">
            ...
            <Button
              ...
              className="bg-dashboard-primary dark:bg-white dark:text-black hover:bg-[#2D4DA8] text-white px-6 py-3 rounded-full font-geist text-sm"
            >
              Change Password
            </Button>
          </div>
              ...
              <Card className="bg-gray-50 border-0 dark:bg-black dark:text-white">
                <CardContent className="p-5">
                  <div className="flex items-end gap-6">
                    ...
                    <Button className="bg-dashboard-primary dark:bg-white dark:text-black hover:bg-[#2D4DA8] text-white px-8 py-3 rounded-full font-geist">
                      ADD
                    </Button>
                  </div>
                </CardContent>
