...
const Table = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableElement> & {
    /**
     * Classes for the scroll container that wraps the table. A sticky
     * `thead` sticks to its nearest scrolling ancestor, which is this
     * wrapper — so capping its height here is what makes the header stay
