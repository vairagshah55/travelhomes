...
export const CamperVanPricing = ({
  ...
  addArrayItem: (f: string) => void;
  removeArrayItem: (f: string, i: number) => void;
}) => (
  <>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <Field label="Per Km Includes">
        <RulesList
          ...
          onAdd={() => addArrayItem("perKmIncludes")}
      ...
      <Field label="Per Km Excludes">
        <RulesList
          ...
          onAdd={() => addArrayItem("perKmExcludes")}
          onRemove={(i) => removeArrayItem("perKmExcludes", i)}
        />
      </Field>
    </div>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <Field label="Per Day Includes">
        <RulesList
          ...
          onAdd={() => addArrayItem("perDayIncludes")}
      ...
      <Field label="Per Day Excludes">
        <RulesList
          ...
          onAdd={() => addArrayItem("perDayExcludes")}
          onRemove={(i) => removeArrayItem("perDayExcludes", i)}
        />
      </Field>
    </div>
  </>
...
/* ─── Unique Stay Pricing ─────────────────────────────────────────────────── */
export const UniqueStayPricing = ({
  formData,
  set,
  errors,
  handleArrayChange,
