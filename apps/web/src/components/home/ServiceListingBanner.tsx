      ...
      <section className="my-8 md:my-12">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] items-center">
            ...
            >
              <h3 className="text-[28px] md:text-[40px] lg:text-[44px] font-semibold text-[#0A2B40] leading-[1.1] tracking-tight">
                It's easy to <span className="text-[#0F5C8A]">host</span> on Travel Homes.
              </h3>
              ...
              <div className="flex gap-8 md:gap-12 pt-2">
                {STATS.map(({ value, label }) => (
                  <div key={label} className="flex flex-col gap-0.5">
                    <span className="text-xl md:text-[26px] font-semibold text-[#0A2B40] leading-none">{value}</span>
              ...
              <Button
                ...
                className="group bg-[#0F5C8A] hover:bg-[#14709F] text-white rounded-full px-8 h-12 font-semibold shadow-sm hover:shadow-md transition-all duration-200 active:scale-[0.98] flex items-center gap-2 w-fit mt-2"
              >
                Become a Host
