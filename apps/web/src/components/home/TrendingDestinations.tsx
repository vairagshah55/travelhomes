...
const DESTINATIONS = [
  {
    image: "https://images.unsplash.com/photo-1587474260584-136574528ed5?w=641&q=80",
    title: "Delhi",
  },
  {
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=641&q=80",
    title: "Kolkata",
  },
  {
    image: "https://images.unsplash.com/photo-1570168007204-dfb528c6958f?w=641&q=80",
    title: "Bombay",
  },
  {
    image: "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=641&q=80",
    title: "Kerala",
  },
];
          ...
          <>
            ...
            >
              <motion.div className="lg:col-span-1 flex flex-col" variants={staggerItem}>
                <div className="mb-6">
                  <h2 className="text-2xl md:text-[28px] font-semibold text-[#0a1c1c] leading-tight tracking-tight">
                    Trending Destinations
                  </h2>
                </div>
                <DestinationCard
