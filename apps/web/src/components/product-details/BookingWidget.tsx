  ...
  return (
    <div className="lg:col-span-1 lg:mt-24 mt-8">
      <div className="sticky top-8 bg-white dark:bg-black dark:text-white border border-gray-200 dark:border-gray-700 rounded-3xl p-6 sm:p-8 shadow-lg">
        ...
        <Button
          className="w-full bg-[#117479] text-white py-4 rounded-xl font-semibold text-lg hover:bg-[#0d4548] shadow-[0_4px_16px_rgba(17, 116, 121,0.25)] hover:shadow-[0_6px_20px_rgba(13, 69, 72,0.35)] transition-all mb-6"
          onClick={onReserve}
        >
          Reserve
        </Button>
