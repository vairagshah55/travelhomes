      ...
      {isOpen && (
        ...
        >
          ...
          >
            <button
              onClick={onClose}
              className="absolute top-4 right-4 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-[#14709F] transition-colors"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                className="w-full bg-gray-900 dark:bg-white dark:text-black text-white rounded-xl py-2.5 text-sm font-semibold hover:bg-[#14709F] dark:hover:bg-gray-100 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              >
