  ...
  return (
    <div className="flex items-center gap-2 flex-shrink-0">
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[#2D4DA8] transition-colors text-sm text-gray-700 dark:text-gray-300"
      >
      ...
      <button
        ...
        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border transition-all duration-300 text-sm ${
          isFavorite
            ...
            : "border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-[#2D4DA8] text-gray-700 dark:text-gray-300"
        }`}
      >
        <Heart
